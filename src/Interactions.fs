    ...
    let data =
        ...
        | Interaction.Recipe recipeInteraction ->
            ...
            Encode.object [
                ...
                "timeStamp", Encode.string (recipeInteraction.Data.TimeStamp.ToLongTimeString())
        ...
        | Interaction.Method methodInteraction ->
            ...
            Encode.object [
                ...
                "timeStamp", Encode.string (methodInteraction.Data.TimeStamp.ToLongTimeString())
                "PartitionKey", Encode.string "mainPartition"
                "RowKey", Encode.string (Guid.NewGuid().ToString())
            ]

    Fetch.post(writeOnlyStorageUrl, data)